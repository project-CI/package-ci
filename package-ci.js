/**
 * @fileOverview The main program for "package-ci".  This where the exported entities reside.
 * @author Rongky <rongkyr3@yahoo.com>
 * @version v0.0.1
 ...
 * @namespace Meteor.package-ci
 */
Meteor.methods({
  /**
   * Get a pet by its nrecord id.
   * @name getPetById
   * @memberof Meteor.package-ci
   * @method
   ...
   * @returns {json}
   */
  package-ci_getPetById: function getPetById(petNum) {
